 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://server.webservice/", wsdlLocation = "http://185.188.181.184:8080/CarServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://server.webservice/", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://185.188.181.184:8080/CarServer?wsdl");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://server.webservice/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice/", "ServerPort"), Server.class, features);
    }
